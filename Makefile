...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2022/08/01 15:07:16 by jkong             #+#    #+#              #
#    Updated: 2022/08/01 15:07:16 by jkong            ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
HEADER = rt.h
SOURCE = program.c rt_ray.c rt_light.c rt_task.c rt_draw.c \
			rt_parse.c rt_format.c rt_format_object.c rt_format_vector.c \
